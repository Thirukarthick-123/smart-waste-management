...
public class MqttConfig {
    ...
    public MessageProducer inbound() {
        MqttPahoMessageDrivenChannelAdapter adapter = new MqttPahoMessageDrivenChannelAdapter(
                "smart-waste-backend-" + System.currentTimeMillis(),
                mqttClientFactory(), "smart-waste/telemetry");
    ...
    public MessageHandler handler() {
        return message -> {
            ...
            try {
                BinDTO binDTO = objectMapper.readValue(payload, BinDTO.class);
                binService.processIncomingData(binDTO);
            } catch (Exception e) {
